...
import DrawerFragments.ParentDrawerFrament;
import Model.News;
...
public class ParentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParentDrawerFrament drawerFragment = (ParentDrawerFrament)
                getSupportFragmentManager().findFragmentById(R.id.parent_navigation_drawer);
        drawerFragment.setUp(R.id.parent_navigation_drawer, (DrawerLayout) findViewById(R.id.drawerlayoutparent), toolbar);

        viewPager = (ViewPager) findViewById(R.id.pager);
        viewPager.setAdapter(new mypageradapter(getSupportFragmentManager()));
        tab = (SlidingTabLayout) findViewById(R.id.parenttab);
        ...
        FetchNewsBdgTask fetchStudentsBackgroundTask = new FetchNewsBdgTask(ParentActivity.this);
